...
classes = ['tibetan_antelope']

parser = argparse.ArgumentParser()
parser.add_argument('--image_path', default='sheep_AUG/images/test',type=str, help="path of images")
parser.add_argument('--label_path', default='sheep_AUG/labels/test',type=str, help="path of labels .txt")
